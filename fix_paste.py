...
# I am completely re-writing get_rotate_rect_info to ensure it uses the offset dx, dy as px3, py3
# and does NOT try to use px3 as absolute destination.
# Also PasteImage top-down coordinates fix.
